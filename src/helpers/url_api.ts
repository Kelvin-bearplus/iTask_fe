...
export const updateTasksListAPI:string= baseURL+"api/v1/tasks/many"
...
export const getMemberAPI:string= baseURL+"api/v1/projectMembers"
...
export const getTaskKanbanAPI:string= baseURL+"api/v1/tasks/kanban"
export const getSprintAPI:string= baseURL+"api/v1/sprints"
export const getProjectActiveAPI:string= baseURL+"api/v1/projects/total"
export const getTotalTaskDoneAPI:string= baseURL+"api/v1/taskAssignees/total-done"
...
export const getOneEricAPI:string= baseURL+"api/v1/tasks/epics"
